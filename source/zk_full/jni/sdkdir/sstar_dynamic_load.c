...
int SSTAR_SNR_OpenLibrary(SensorAssembly_t *pstSnrAssembly)
{
	...
	pstSnrAssembly->pfnSnrEnable = (MI_S32(*)(MI_SNR_PADID ePADId))dlsym(pstSnrAssembly->pHandle, "MI_SNR_Enable");
	...
	pstSnrAssembly->pfnSnrDisable = (MI_S32(*)(MI_SNR_PADID ePADId))dlsym(pstSnrAssembly->pHandle, "MI_SNR_Disable");
	...
	pstSnrAssembly->pfnSnrGetPadInfo = (MI_S32(*)(MI_SNR_PADID ePADId, MI_SNR_PADInfo_t  *pstPadInfo))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetPadInfo");
	...
	pstSnrAssembly->pfnSnrGetPlaneInfo = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32  u32PlaneID, MI_SNR_PlaneInfo_t *pstPlaneInfo))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetPlaneInfo");
	...
	pstSnrAssembly->pfnSnrGetFps = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32 *pFps))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetFps");
	...
	pstSnrAssembly->pfnSnrSetFps = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32 u32Fps))dlsym(pstSnrAssembly->pHandle, "MI_SNR_SetFps");
	...
	pstSnrAssembly->pfnSnrSetAnadecSrcAttr = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32 u32PlaneID, MI_SNR_Anadec_SrcAttr_t *pstSrcAttr))dlsym(pstSnrAssembly->pHandle, "MI_SNR_SetAnadecSrcAttr");
	if(NULL == pstSnrAssembly->pfnSnrSetAnadecSrcAttr)
	{
		printf(" %s: dlsym MI_SNR_SetAnadecSrcAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstSnrAssembly->pfnSnrGetAnadecSrcAttr = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32 u32PlaneID, MI_SNR_Anadec_SrcAttr_t *pstSrcAttr))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetAnadecSrcAttr");
	if(NULL == pstSnrAssembly->pfnSnrGetAnadecSrcAttr)
	{
		printf(" %s: dlsym MI_SNR_GetAnadecSrcAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstSnrAssembly->pfnSnrQueryResCount = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32 *pu32ResCount))dlsym(pstSnrAssembly->pHandle, "MI_SNR_QueryResCount");
	...
	pstSnrAssembly->pfnSnrGetRes = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U8 u8ResIdx, MI_SNR_Res_t *pstRes))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetRes");
	...
	pstSnrAssembly->pfnSnrGetCurRes = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U8 *pu8CurResIdx, MI_SNR_Res_t  *pstCurRes))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetCurRes");
	...
	pstSnrAssembly->pfnSnrSetRes = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U8 u8ResIdx))dlsym(pstSnrAssembly->pHandle, "MI_SNR_SetRes");
	...
	pstSnrAssembly->pfnSnrSetOrien = (MI_S32(*)(MI_SNR_PADID ePADId, MI_BOOL bMirror, MI_BOOL bFlip))dlsym(pstSnrAssembly->pHandle, "MI_SNR_SetOrien");
	...
	pstSnrAssembly->pfnSnrGetOrien = (MI_S32(*)(MI_SNR_PADID ePADId, MI_BOOL *pbMirror, MI_BOOL *pbFlip))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetOrien");
	...
	pstSnrAssembly->pfnSnrSetPlaneMode = (MI_S32(*)(MI_SNR_PADID ePADId, MI_BOOL bEnable))dlsym(pstSnrAssembly->pHandle, "MI_SNR_SetPlaneMode");
	...
	pstSnrAssembly->pfnSnrGetPlaneMode = (MI_S32(*)(MI_SNR_PADID ePADId, MI_BOOL *pbEnable))dlsym(pstSnrAssembly->pHandle, "MI_SNR_GetPlaneMode");
	...
	pstSnrAssembly->pfnSnrCustFunction = (MI_S32(*)(MI_SNR_PADID ePADId, MI_U32 u32CmdId, MI_U32 u32DataSize, void *pCustData, MI_SNR_CUST_DIR_e eDir))dlsym(pstSnrAssembly->pHandle, "MI_SNR_CustFunction");
...
int SSTAR_VIF_OpenLibrary(VifAssembly_t *pstVifAssembly)
{
	...
	pstVifAssembly->pfnVifCreateDevGroup = (MI_S32(*)(MI_VIF_GROUP GroupId, MI_VIF_GroupAttr_t *pstGroupAttr))dlsym(pstVifAssembly->pHandle, "MI_VIF_CreateDevGroup");
	if(NULL == pstVifAssembly->pfnVifCreateDevGroup)
	{
		printf(" %s: dlsym MI_VIF_CreateDevGroup failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifCreateDevGroupExt = (MI_S32(*)(MI_VIF_GROUP GroupId, MI_VIF_GroupAttr_t *pstGroupAttr, MI_VIF_GroupExtAttr_t *pstGroupOptionExtAttr))dlsym(pstVifAssembly->pHandle, "MI_VIF_CreateDevGroupExt");
	if(NULL == pstVifAssembly->pfnVifCreateDevGroupExt)
	{
		printf(" %s: dlsym MI_VIF_CreateDevGroupExt failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifDestroyDevGroup = (MI_S32(*)(MI_VIF_GROUP GroupId))dlsym(pstVifAssembly->pHandle, "MI_VIF_DestroyDevGroup");
	if(NULL == pstVifAssembly->pfnVifDestroyDevGroup)
	{
		printf(" %s: dlsym MI_VIF_DestroyDevGroup failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifGetDevGroupAttr = (MI_S32(*)(MI_VIF_GROUP GroupId, MI_VIF_GroupAttr_t *pstGroupAttr))dlsym(pstVifAssembly->pHandle, "MI_VIF_GetDevGroupAttr");
	if(NULL == pstVifAssembly->pfnVifGetDevGroupAttr)
	{
		printf(" %s: dlsym MI_VIF_GetDevGroupAttr failed, %s\n", __func__, dlerror());
		return -1;
	}
	...
	pstVifAssembly->pfnVifGetDevStatus = (MI_S32(*)(MI_VIF_DEV DevId,MI_VIF_DevStatus_t *pstVifDevStatus))dlsym(pstVifAssembly->pHandle, "MI_VIF_GetDevStatus");
	if(NULL == pstVifAssembly->pfnVifGetDevStatus)
	{
		printf(" %s: dlsym MI_VIF_GetDevStatus failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifSetOutputPortAttr = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_PORT PortId, MI_VIF_OutputPortAttr_t *pstAttr))dlsym(pstVifAssembly->pHandle, "MI_VIF_SetOutputPortAttr");
	if(NULL == pstVifAssembly->pfnVifSetOutputPortAttr)
	{
		printf(" %s: dlsym MI_VIF_SetOutputPortAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifGetOutputPortAttr = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_PORT PortId, MI_VIF_OutputPortAttr_t *pstAttr))dlsym(pstVifAssembly->pHandle, "MI_VIF_GetOutputPortAttr");
	if(NULL == pstVifAssembly->pfnVifGetOutputPortAttr)
	{
		printf(" %s: dlsym MI_VIF_GetOutputPortAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifEnableOutputPort = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_PORT PortId))dlsym(pstVifAssembly->pHandle, "MI_VIF_EnableOutputPort");
	if(NULL == pstVifAssembly->pfnVifEnableOutputPort)
	{
		printf(" %s: dlsym MI_VIF_EnableOutputPort failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifDisableOutputPort = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_PORT PortId))dlsym(pstVifAssembly->pHandle, "MI_VIF_DisableOutputPort");
	if(NULL == pstVifAssembly->pfnVifDisableOutputPort)
	{
		printf(" %s: dlsym MI_VIF_DisableOutputPort failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifQuery = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_PORT PortId, MI_VIF_DevPortStat_t *pstStat))dlsym(pstVifAssembly->pHandle, "MI_VIF_Query");
	...
	pstVifAssembly->pfnVifCallBackTask_Register = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_CallBackParam_t *pstCallBackParam))dlsym(pstVifAssembly->pHandle, "MI_VIF_CallBackTask_Register");
	if(NULL == pstVifAssembly->pfnVifCallBackTask_Register)
	{
		printf(" %s: dlsym MI_VIF_CallBackTask_Register failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVifAssembly->pfnVifCallBackTask_UnRegister = (MI_S32(*)(MI_VIF_DEV DevId, MI_VIF_CallBackParam_t *pstCallBackParam))dlsym(pstVifAssembly->pHandle, "MI_VIF_CallBackTask_UnRegister");
	if(NULL == pstVifAssembly->pfnVifCallBackTask_UnRegister)
	{
		printf(" %s: dlsym MI_VIF_CallBackTask_UnRegister failed, %s\n", __func__, dlerror());
		return -1;
	}
...
int SSTAR_ISP_OpenLibrary(IspAssembly_t *pstIspAssembly)
{
	...
	pstIspAssembly->pfnIspIqGetParaInitStatus = (MI_S32(*)(MI_U32 DevId, MI_U32 Channel, MI_ISP_IQ_PARAM_INIT_INFO_TYPE_t *data))dlsym(pstIspAssembly->pHandle, "MI_ISP_IQ_GetParaInitStatus");
...
{
	pstVdecAssembly->pHandle = dlopen("libmi_vdec.so", RTLD_NOW);		// libcus3a.so  ?
	if (NULL == pstVdecAssembly->pHandle)
	{
		printf(" %s: Can not load libmi_vdec.so!\n", __func__);
		return -1;
	}

	pstVdecAssembly->pfnVdecCreateDev = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_InitParam_t *pstInitParam))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_CreateDev");
	if(NULL == pstVdecAssembly->pfnVdecCreateDev)
	{
		printf(" %s: dlsym MI_VDEC_CreateDev failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecDestroyDev = (MI_S32(*)(MI_VDEC_DEV VdecDev))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_DestroyDev");
	if(NULL == pstVdecAssembly->pfnVdecDestroyDev)
	{
		printf(" %s: dlsym MI_VDEC_DestroyDev failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecCreateChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_ChnAttr_t *pstChnAttr))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_CreateChn");
	if(NULL == pstVdecAssembly->pfnVdecCreateChn)
	{
		printf(" %s: dlsym MI_VDEC_CreateChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecDestroyChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_DestroyChn");
	if(NULL == pstVdecAssembly->pfnVdecDestroyChn)
	{
		printf(" %s: dlsym MI_VDEC_DestroyChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetChnAttr = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_ChnAttr_t *pstChnAttr))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetChnAttr");
	if(NULL == pstVdecAssembly->pfnVdecGetChnAttr)
	{
		printf(" %s: dlsym MI_VDEC_GetChnAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecStartChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_StartChn");
	if(NULL == pstVdecAssembly->pfnVdecStartChn)
	{
		printf(" %s: dlsym MI_VDEC_StartChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecStopChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_StopChn");
	if(NULL == pstVdecAssembly->pfnVdecStopChn)
	{
		printf(" %s: dlsym MI_VDEC_StopChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetChnStat = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_ChnStat_t *pstChnStat))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetChnStat");
	if(NULL == pstVdecAssembly->pfnVdecGetChnStat)
	{
		printf(" %s: dlsym MI_VDEC_GetChnStat failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecFlushChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_FlushChn");
	if(NULL == pstVdecAssembly->pfnVdecFlushChn)
	{
		printf(" %s: dlsym MI_VDEC_FlushChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecResetChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_ResetChn");
	if(NULL == pstVdecAssembly->pfnVdecResetChn)
	{
		printf(" %s: dlsym MI_VDEC_ResetChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetChnParam = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_ChnParam_t *pstChnParam))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetChnParam");
	if(NULL == pstVdecAssembly->pfnVdecSetChnParam)
	{
		printf(" %s: dlsym MI_VDEC_SetChnParam failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetChnParam = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_ChnParam_t *pstChnParam))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetChnParam");
	if(NULL == pstVdecAssembly->pfnVdecGetChnParam)
	{
		printf(" %s: dlsym MI_VDEC_GetChnParam failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSendStream = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_VideoStream_t *pstVideoStream, MI_S32 s32MilliSec))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SendStream");
	if(NULL == pstVdecAssembly->pfnVdecSendStream)
	{
		printf(" %s: dlsym MI_VDEC_SendStream failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecPauseChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_PauseChn");
	if(NULL == pstVdecAssembly->pfnVdecPauseChn)
	{
		printf(" %s: dlsym MI_VDEC_PauseChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecRefreshChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_RefreshChn");
	if(NULL == pstVdecAssembly->pfnVdecRefreshChn)
	{
		printf(" %s: dlsym MI_VDEC_RefreshChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecResumeChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_ResumeChn");
	if(NULL == pstVdecAssembly->pfnVdecResumeChn)
	{
		printf(" %s: dlsym MI_VDEC_ResumeChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecStepChn = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_StepChn");
	if(NULL == pstVdecAssembly->pfnVdecStepChn)
	{
		printf(" %s: dlsym MI_VDEC_StepChn failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetUserData = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_UserData_t *pstUserData, MI_S32 s32MilliSec))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetUserData");
	if(NULL == pstVdecAssembly->pfnVdecGetUserData)
	{
		printf(" %s: dlsym MI_VDEC_GetUserData failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecReleaseUserData = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_UserData_t *pstUserData))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_ReleaseUserData");
	if(NULL == pstVdecAssembly->pfnVdecReleaseUserData)
	{
		printf(" %s: dlsym MI_VDEC_ReleaseUserData failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetDisplayMode = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_DisplayMode_e eDisplayMode))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetDisplayMode");
	if(NULL == pstVdecAssembly->pfnVdecSetDisplayMode)
	{
		printf(" %s: dlsym MI_VDEC_SetDisplayMode failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetDisplayMode = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_DisplayMode_e *peDisplayMode))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetDisplayMode");
	if(NULL == pstVdecAssembly->pfnVdecGetDisplayMode)
	{
		printf(" %s: dlsym MI_VDEC_GetDisplayMode failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetOutputPortAttr = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_OutputPortAttr_t *pstOutputPortAttr))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetOutputPortAttr");
	if(NULL == pstVdecAssembly->pfnVdecSetOutputPortAttr)
	{
		printf(" %s: dlsym MI_VDEC_SetOutputPortAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetOutputPortAttrEx = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_U32 u32Port, MI_VDEC_OutputPortAttr_t *pstOutputPortAttr))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetOutputPortAttrEx");
	if(NULL == pstVdecAssembly->pfnVdecSetOutputPortAttrEx)
	{
		printf(" %s: dlsym MI_VDEC_SetOutputPortAttrEx failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetOutputPortAttr = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_OutputPortAttr_t *pstOutputPortAttr))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetOutputPortAttr");
	if(NULL == pstVdecAssembly->pfnVdecGetOutputPortAttr)
	{
		printf(" %s: dlsym MI_VDEC_GetOutputPortAttr failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetOutputPortAttrEx = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_U32 u32Port, MI_VDEC_OutputPortAttr_t *pstOutputPortAttr))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetOutputPortAttrEx");
	if(NULL == pstVdecAssembly->pfnVdecGetOutputPortAttrEx)
	{
		printf(" %s: dlsym MI_VDEC_GetOutputPortAttrEx failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetOutputPortLayoutMode = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_OutbufLayoutMode_e eBufTileMode))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetOutputPortLayoutMode");
	if(NULL == pstVdecAssembly->pfnVdecSetOutputPortLayoutMode)
	{
		printf(" %s: dlsym MI_VDEC_SetOutputPortLayoutMode failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetOutputPortLayoutMode = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_OutbufLayoutMode_e *peBufTileMode))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetOutputPortLayoutMode");
	if(NULL == pstVdecAssembly->pfnVdecGetOutputPortLayoutMode)
	{
		printf(" %s: dlsym MI_VDEC_GetOutputPortLayoutMode failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetDestCrop = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_CropCfg_t *pstCropCfg))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetDestCrop");
	if(NULL == pstVdecAssembly->pfnVdecSetDestCrop)
	{
		printf(" %s: dlsym MI_VDEC_SetDestCrop failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetDestCropEx = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_U32 u32Port, MI_VDEC_CropCfg_t *pstCropCfg))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetDestCropEx");
	if(NULL == pstVdecAssembly->pfnVdecSetDestCropEx)
	{
		printf(" %s: dlsym MI_VDEC_SetDestCropEx failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetDestCrop = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_CropCfg_t *pstCropCfg))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetDestCrop");
	if(NULL == pstVdecAssembly->pfnVdecGetDestCrop)
	{
		printf(" %s: dlsym MI_VDEC_GetDestCrop failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecGetDestCropEx = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_U32 u32Port, MI_VDEC_CropCfg_t *pstCropCfg))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_GetDestCropEx");
	if(NULL == pstVdecAssembly->pfnVdecGetDestCropEx)
	{
		printf(" %s: dlsym MI_VDEC_GetDestCropEx failed, %s\n", __func__, dlerror());
		return -1;
	}

	pstVdecAssembly->pfnVdecSetChnErrHandlePolicy = (MI_S32(*)(MI_VDEC_DEV VdecDev, MI_VDEC_CHN VdecChn, MI_VDEC_ErrHandlePolicy_t *pstErrHandlePolicy))dlsym(pstVdecAssembly->pHandle, "MI_VDEC_SetChnErrHandlePolicy");
	if(NULL == pstVdecAssembly->pfnVdecSetChnErrHandlePolicy)
	{
		printf(" %s: dlsym MI_VDEC_SetChnErrHandlePolicy failed, %s\n", __func__, dlerror());
		return -1;
	}
...
{
	if(pstVdecAssembly->pHandle)
	{
		dlclose(pstVdecAssembly->pHandle);
		pstVdecAssembly->pHandle = NULL;
	}
	memset(pstVdecAssembly, 0, sizeof(*pstVdecAssembly));
}
